...
public class PaletteEntityListener extends EntityListener {
	...
	public void mouseDoubleClicked(Entity me) {
		...
		if (d != null) {
			...
			cmd = new AddEntity(e,
					handler.realignToGrid(upperLeftX / oldZoomDiagram * Constants.DEFAULTGRIDSIZE + Constants.PASTE_DISPLACEMENT),
					handler.realignToGrid(upperLeftY / oldZoomDiagram * Constants.DEFAULTGRIDSIZE + Constants.PASTE_DISPLACEMENT)
					);
