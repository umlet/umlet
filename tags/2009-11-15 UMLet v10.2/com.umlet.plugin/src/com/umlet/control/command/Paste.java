...
public class Paste extends Command {
	...
	public void execute(DiagramHandler handler) {
		...
		for (Entity e : this.entities) {
			...
			// }
			(new AddEntity(e,
					handler.ensureOnGrid(e.getX() - minX + upperLeftX / oldZoom * Constants.DEFAULTGRIDSIZE + Constants.PASTE_DISPLACEMENT),
					handler.ensureOnGrid(e.getY() - minY + upperLeftY / oldZoom * Constants.DEFAULTGRIDSIZE + Constants.PASTE_DISPLACEMENT))).execute(handler);
		}
