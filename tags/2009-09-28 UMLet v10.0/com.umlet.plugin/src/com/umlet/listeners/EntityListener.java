...
public class EntityListener extends UniversalListener {
	...
	public void mouseMoved(MouseEvent me) {
		...
		if (0 != ra) {
			if ((ra == 1) | (ra == 4)) Umlet.getInstance().getGUI().setCursor(Constants.tbCursor);
			if ((ra == 2) | (ra == 8)) Umlet.getInstance().getGUI().setCursor(Constants.lrCursor);
			if ((ra == 3) | (ra == 12)) Umlet.getInstance().getGUI().setCursor(Constants.neCursor);
			if ((ra == 6) | (ra == 9)) Umlet.getInstance().getGUI().setCursor(Constants.nwCursor);
		}
		else Umlet.getInstance().getGUI().setCursor(Constants.handCursor);
	}
