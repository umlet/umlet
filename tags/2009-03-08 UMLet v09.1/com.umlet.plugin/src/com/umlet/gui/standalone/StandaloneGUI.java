...
public class StandaloneGUI extends UmletGUI {
	...
	private JMenuItem menu_file_save_as_img;
	private JMenuItem menu_file_save_as_svg;
	private JMenuItem menu_file_save_as_pdf;
	private JMenuItem menu_file_save_as_eps;
	...
	protected void init() {
	    ...
	    menu_file_save_as_img = new JMenuItem("Save as Image...");
	    menu_file_save_as_img.addActionListener(mlistener); 
	    menu_file_save_as_svg = new JMenuItem("Save as SVG...");
	    menu_file_save_as_svg.addActionListener(mlistener);
	    menu_file_save_as_pdf = new JMenuItem("Save as PDF...");
	    menu_file_save_as_pdf.addActionListener(mlistener);
	    menu_file_save_as_eps = new JMenuItem("Save as EPS...");
	    menu_file_save_as_eps.addActionListener(mlistener);
	    ...
	    menu_file.add(menu_file_save_as_img);
	    menu_file.add(menu_file_save_as_svg);
	    menu_file.add(menu_file_save_as_pdf);
	    menu_file.add(menu_file_save_as_eps);
		...
		menu_file_save_as_img.setEnabled(false);
		menu_file_save_as_svg.setEnabled(false);
		menu_file_save_as_pdf.setEnabled(false);
		menu_file_save_as_eps.setEnabled(false);
	...
	public void diagramSelected(DiagramHandler handler) {
		if(handler == null)
		{
			...
			menu_file_save_as_img.setEnabled(true);
			menu_file_save_as_svg.setEnabled(true);
			menu_file_save_as_pdf.setEnabled(true);
			menu_file_save_as_eps.setEnabled(true);
