...
public class CustomElementSecurityManager extends SecurityManager {
	...
	public CustomElementSecurityManager() {
		...
		this.allowedPackages.add("com.umlet.constants");
		this.allowedPackages.add("java.awt.geom");
		this.allowedPackages.add("java.awt.font");
		this.allowedPackages.add("java.awt");
	}
	...
	public void checkPropertyAccess(String arg0) {
		if(!"sun.awt.exception.handler".equals(arg0))
			this.customElementAccess("checkPropertyAccess");
	}
	...
	public void checkWrite(String arg0) {
		if(privilegedthreads.containsKey(Thread.currentThread()))
			if(arg0.equals(privilegedthreads.get(Thread.currentThread())))
				return;
