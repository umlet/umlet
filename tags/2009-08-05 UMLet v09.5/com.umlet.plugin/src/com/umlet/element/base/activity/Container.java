...
public class Container extends Element {
	...
	public Container(Graphics2D g, Container parent, ArrayList<Row> rows, int row) {
		...
		if(Const.AutoInsertIF && this.parent != null)
			this.setStartElement(new If(g,null));
		else if (this.parent != null)
			this.setStartElement(new StartElement(g,0,null));
	}
	...
	public Container close() {
		if(Const.AutoInsertIF && this.parent != null)
			this.setStopElement(new EndIf(this.getGraphics(),null));
		else if (this.parent != null)
			this.setStopElement(new StopElement(this.getGraphics(),0,null));
		return this.parent;
	}
	...
	protected int getLeftWidth() {
		...
		width += ((float)(this.columns.size()-1))/2.0 * Const.COLUMN_PAD;
