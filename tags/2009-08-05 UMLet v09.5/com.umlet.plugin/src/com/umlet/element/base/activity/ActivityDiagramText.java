    		...
    		if(m.matches()) {
    			...
    			if(m.group(4) != null) {
    				...
    				/*GET EVENT*/
    					...
    					e = new EventRecieve(graphics,m.group(15),id);
    				/*RAISE EVENT*/
    				else if(m.group(17) != null)
    					e = new EventRaise(graphics,m.group(17),id);
    				/*PARTACTIVITY*/
    				else if (m.group(19) != null)
    						e = new PartActivity(m.group(19),graphics,id);
    				/*ACTIVITY*/
    				else if (m.group(20) != null)
    						e = new Activity(m.group(20),graphics,id);
    			}
