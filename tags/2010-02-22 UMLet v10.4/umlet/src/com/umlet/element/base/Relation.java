...
public class Relation extends Entity {
	...
	public void paintEntity(Graphics g) {
		...
		if ((beginQualifier != null) && (beginQualifier.length() > 0)) {
			TextLayout tl = new TextLayout(beginQualifier, this.getHandler().getZoomedFont(), Constants.getFRC(g2));
		...
		if ((beginMultiplicity != null) && (beginMultiplicity.length() > 0)) {
			...
			startShapes.add(e);
			TextLayout tl = new TextLayout(beginMultiplicity, this.getHandler().getZoomedFont(), Constants.getFRC(g2));
		...
		if ((endMultiplicity != null) && (endMultiplicity.length() > 0)) {
			EmptyShape e = new EmptyShape((int) this.getHandler().getZoomedFontsize());
			endShapes.add(e);
			TextLayout tl = new TextLayout(endMultiplicity, this.getHandler().getZoomedFont(), Constants.getFRC(g2));
		...
		if ((beginPort != null) && (beginPort.length() > 0)) {
			...
			EmptyShape e = new EmptyShape((int) this.getHandler().getZoomedFontsize());
			startShapes.add(e);
			TextLayout tl = new TextLayout(beginPort, this.getHandler().getZoomedFont(), Constants.getFRC(g2));
		...
		if ((endPort != null) && (endPort.length() > 0)) {
			EmptyShape e = new EmptyShape((int) this.getHandler().getZoomedFontsize());
			endShapes.add(e);
			TextLayout tl = new TextLayout(endPort, this.getHandler().getZoomedFont(), Constants.getFRC(g2));
