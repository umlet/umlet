...
public class HistoryState extends Entity {
	...
	public void paintEntity(Graphics g) {
		...
		Rectangle2D bounds = this.getHandler().getZoomedFont().getStringBounds("H", Constants.getFRC(g2));
		LineMetrics metrics = this.getHandler().getZoomedFont().getLineMetrics("H", Constants.getFRC(g2));
