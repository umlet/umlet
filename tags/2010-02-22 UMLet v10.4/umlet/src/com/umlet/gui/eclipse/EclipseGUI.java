...
public class EclipseGUI extends UmletGUI {
	...
	private static Logger log = Logger.getLogger(EclipseGUI.class.getName());
	...
	public String getSelectedPalette() {
		if (this.editor != null) { return this.editor.getSelectedPaletteName() + ".uxf"; }
		return null;
	}
	...
	public UMLetContributor getContributor() {
