...
public class TextManipulator {
	...
	public static boolean checkifStringFits(String text, float width, BaseDrawHandlerSwing drawer) {
		return splitString(text, width, drawer).equals(text);
	}
	
	public static String splitString(String text, float width, BaseDrawHandlerSwing drawer) {
	...
	private static String splitStringAlgorithm(String text, float width, BaseDrawHandlerSwing drawer) {
		String splitChar = " ";
