...
public class Note extends OldGridElement {
	...
	public void paintEntity(Graphics g) {
		...
		poly.addPoint(getRectangle().width - (int) Main.getHandlerForElement(this).getFontHandler().getFontSize(), 0);
		poly.addPoint(getRectangle().width - 1, (int) Main.getHandlerForElement(this).getFontHandler().getFontSize());
		poly.addPoint(getRectangle().width - 1, (int) Main.getHandlerForElement(this).getFontHandler().getFontSize());
		...
		g2.drawLine(getRectangle().width - (int) Main.getHandlerForElement(this).getFontHandler().getFontSize(), 0, getRectangle().width - 1, (int) Main.getHandlerForElement(this).getFontHandler().getFontSize());
		g2.drawLine(getRectangle().width - 1, (int) Main.getHandlerForElement(this).getFontHandler().getFontSize(), getRectangle().width - 1, getRectangle().height - 1);
		g2.drawLine(getRectangle().width - 1, getRectangle().height - 1, 0, getRectangle().height - 1);
		g2.drawLine(0, getRectangle().height - 1, 0, 0);
		g2.drawLine(getRectangle().width - (int) Main.getHandlerForElement(this).getFontHandler().getFontSize(), 0, getRectangle().width - (int) Main.getHandlerForElement(this).getFontHandler().getFontSize(), (int) Main.getHandlerForElement(this).getFontHandler().getFontSize());
		g2.drawLine(getRectangle().width - (int) Main.getHandlerForElement(this).getFontHandler().getFontSize(), (int) Main.getHandlerForElement(this).getFontHandler().getFontSize(), getRectangle().width - 1, (int) Main.getHandlerForElement(this).getFontHandler().getFontSize());
	}
}
