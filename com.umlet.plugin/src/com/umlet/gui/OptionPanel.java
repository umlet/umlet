...
public class OptionPanel extends JPanel implements ActionListener {
	...
	{	
		...
		this.add(new JLabel("Show Stickingpolygon"));
		...
		this.optionframe.setSize(250,180);
	}
	...
	public void showOptionPanel() 
	{
		...
		this.default_fontsize.setSelectedItem(Constants.default_fontsize);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(ae.getActionCommand().equals("Ok"))
		{
			...
			if(Constants.default_fontsize != newsize) {
				Constants.default_fontsize = newsize;
