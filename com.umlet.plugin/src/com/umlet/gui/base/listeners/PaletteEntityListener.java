...
public class PaletteEntityListener extends EntityListener {
	...
	public void mouseDoubleClicked(Entity me) {
		...
		if (d != null) {
			...
			cmd = new AddEntity(e,
					handler.ensureOnGrid(upperLeftX / oldZoomDiagram * Constants.DEFAULTGRIDSIZE + Constants.PASTE_DISPLACEMENT),
					handler.ensureOnGrid(upperLeftY / oldZoomDiagram * Constants.DEFAULTGRIDSIZE + Constants.PASTE_DISPLACEMENT)
					);
