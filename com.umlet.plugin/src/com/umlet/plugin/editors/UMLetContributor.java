...
public class UMLetContributor extends EditorActionBarContributor {
	...
	private void createMenuActions() {
		...
		this.exportactions.add(new ExportAction("Export to EPS", "eps"));
		this.exportactions.add(new ExportAction("Export to PDF", "pdf"));
		this.exportactions.add(new ExportAction("Export to SVG", "svg"));
