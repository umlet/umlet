...
public class Signal extends Entity {
	...
	public void paintEntity(Graphics g) {
		...
		if (signalType == 1) { // send signal
			...
			g2.drawLine(this.getWidth() - (int) this.getHandler().getZoomedFontsize(), this.getHeight() - 1, 0, this.getHeight() - 1);
			g2.drawLine(this.getWidth() - (int) this.getHandler().getZoomedFontsize(), 0, this.getWidth() - 1, this.getHeight() / 2);
			g2.drawLine(this.getWidth(), this.getHeight() / 2, this.getWidth() - (int) this.getHandler().getZoomedFontsize(), this.getHeight());
			...
			g2.drawLine(0, 0, (int) this.getHandler().getZoomedFontsize() - 2, this.getHeight() / 2);
			g2.drawLine((int) this.getHandler().getZoomedFontsize() - 2, this.getHeight() / 2, 0, this.getHeight());
