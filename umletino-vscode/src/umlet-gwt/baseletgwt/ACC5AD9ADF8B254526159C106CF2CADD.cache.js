...
var Ljava_lang_Class_2_classLit = createForClass('java.lang', 'Class', 307);
...
defineClass(392, 1, {300:1}, BaseletGWT$1);
...
defineClass(393, 1, {26:1, 996:1}, BaseletGWT$2);
...
function $runAsyncImpl(this$static, fragment, callback){
  ...
  callbacks = this$static.allCallbacks[fragment];
  callbacks == null && (callbacks = this$static.allCallbacks[fragment] = initUnidimensionalArray(Lcom_google_gwt_core_client_RunAsyncCallback_2_classLit, $intern_13, 300, 0, 0, 1));
...
function AsyncFragmentLoader(numEntries, initialLoadSequence, loadingStrategy){
  ...
  this.pendingDownloadErrorHandlers = initUnidimensionalArray(Lcom_google_gwt_core_client_impl_AsyncFragmentLoader$LoadTerminatedHandler_2_classLit, $intern_13, 305, numEntriesPlusOne, 0, 1);
}
...
defineClass(406, 1, {305:1}, AsyncFragmentLoader$1);
...
defineClass(304, 1, {}, AsyncFragmentLoader$BoundedIntQueue);
_.read = 0;
_.write_0 = 0;
var Lcom_google_gwt_core_client_impl_AsyncFragmentLoader$BoundedIntQueue_2_classLit = createForClass('com.google.gwt.core.client.impl', 'AsyncFragmentLoader/BoundedIntQueue', 304);
...
function $loadTerminated(this$static, reason){
  ...
  this$static.this$01.pendingDownloadErrorHandlers = initUnidimensionalArray(Lcom_google_gwt_core_client_impl_AsyncFragmentLoader$LoadTerminatedHandler_2_classLit, $intern_13, 305, this$static.this$01.numEntries + 1, 0, 1);
...
defineClass(407, 1, {305:1}, AsyncFragmentLoader$ResetAfterDownloadFailure);
...
defineClass(493, 995, {}, SchedulerImpl);
...
;
var Lcom_google_gwt_core_client_impl_ScriptTagLoadingStrategy$ScriptTagDownloadStrategy$1_2_classLit = createForClass('com.google.gwt.core.client.impl', 'ScriptTagLoadingStrategy/ScriptTagDownloadStrategy/1', 310);
...
defineClass(416, 1010, {}, StackTraceCreator$CollectorLegacy);
...
defineClass(417, 1011, {}, StackTraceCreator$CollectorModernNoSourceMap);
...
defineClass(611, 997, {}, AttachEvent);
_.dispatch_0 = function dispatch_24(handler){
  castTo(handler, 1060).onAttachOrDetach(this);
}
;
...
defineClass(609, 997, {}, CloseEvent_0);
...
defineClass(302, 1, {980:1}, LegacyHandlerWrapper);
var Lcom_google_gwt_event_shared_LegacyHandlerWrapper_2_classLit = createForClass('com.google.gwt.event.shared', 'LegacyHandlerWrapper', 302);
...
defineClass(263, 1023, {}, TextLogFormatter);
...
defineClass(311, 1012, {}, FilterOutputStream);
var Ljava_io_FilterOutputStream_2_classLit = createForClass('java.io', 'FilterOutputStream', 311);
function PrintStream(out){
  FilterOutputStream.call(this, out);
}

defineClass(249, 311, {}, PrintStream);
...
defineClass(395, 997, {}, Window$ClosingEvent);
...
defineClass(610, 1, $intern_39, WidgetCollection);
...
defineClass(312, 10, $intern_5, ArrayStoreException);
var Ljava_lang_ArrayStoreException_2_classLit = createForClass('java.lang', 'ArrayStoreException', 312);
function $clinit_Boolean(){
  $clinit_Boolean = emptyMethod;
  FALSE = false;
}

booleanCastMap = {3:1, 306:1, 9:1};
var FALSE;
var Ljava_lang_Boolean_2_classLit = createForClass('java.lang', 'Boolean', 306);
...
stringCastMap = {3:1, 299:1, 9:1, 2:1};
...
defineClass(309, 64, $intern_41, StringIndexOutOfBoundsException);
var Ljava_lang_StringIndexOutOfBoundsException_2_classLit = createForClass('java.lang', 'StringIndexOutOfBoundsException', 309);
...
defineClass($intern_45, 1014, $intern_46);
...
defineClass(538, $intern_47, $intern_49, Collections$EmptyList);
...
defineClass(541, 1017, $intern_11, Collections$EmptyMap);
...
defineClass(540, $intern_45, $intern_50, Collections$EmptySet);
...
defineClass(255, 319, $intern_48, Collections$UnmodifiableList);
...
defineClass(301, 1, $intern_10, Collections$UnmodifiableMap);
...
defineClass(543, 542, $intern_46, Collections$UnmodifiableMap$UnmodifiableEntrySet);
...
defineClass(320, 255, {21:1, 49:1, 40:1, 214:1}, Collections$UnmodifiableRandomAccessList);
...
defineClass(608, 1, $intern_39, InternalHashCodeMap);
...
defineClass(606, 1, $intern_39, InternalStringMap);
...
defineClass(607, $intern_26, {44:1}, InternalStringMap$2);
...
defineClass(308, 1, {}, StringJoiner);
_.toString_0 = function toString_63(){
  return !this.builder?this.emptyValue:this.suffix.length == 0?this.builder.string:this.builder.string + ('' + this.suffix);
}
;
var Ljava_util_StringJoiner_2_classLit = createForClass('java.util', 'StringJoiner', 308);
