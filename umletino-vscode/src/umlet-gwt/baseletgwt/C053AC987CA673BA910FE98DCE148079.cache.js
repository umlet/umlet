...
var $strongName = 'C053AC987CA673BA910FE98DCE148079';
var $gwt = {};
...
_.dispatch_0 = function dispatch_23(handler){
  castTo(handler, 1054).onAttachOrDetach(this);
}
;
...
defineClass(46, 218, $intern_42, Integer);
...
defineClass(735, 10, $intern_5, ConcurrentModificationException);
var Ljava_util_ConcurrentModificationException_2_classLit = createForClass('java.util', 'ConcurrentModificationException', 735);
...
defineClass(1034, 1, {});
var Ljavaemul_internal_ConsoleLogger_2_classLit = createForClass('javaemul.internal', 'ConsoleLogger', 1034);
