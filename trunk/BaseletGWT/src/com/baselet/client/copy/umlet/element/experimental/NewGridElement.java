...
import com.baselet.client.copy.diagram.draw.geom.Dimension;
import com.baselet.client.copy.diagram.draw.geom.Line;
...
import com.baselet.client.copy.element.GroupGridElement;
import com.baselet.client.copy.element.StickingPolygon;
import com.baselet.client.copy.gui.AutocompletionText;
import com.baselet.client.copy.umlet.element.experimental.settings.Settings;
import com.baselet.client.copy.umlet.element.experimental.settings.facets.Facet;
import com.baselet.client.copy.umlet.element.experimental.settings.facets.DefaultGlobalFacet.ElementStyleEnum;
import com.baselet.client.copy.umlet.element.experimental.settings.facets.DefaultGlobalFacet.GlobalSetting;
...
//		this.getHandler().getDrawPanel().getSelector().updateSelectorInformation(); // update the property panel to display changed attributes
	...
	/**
	 * @see com.baselet.client.copy.element.GridElement#getRealSize()
	 */
	@Override
