...
import com.baselet.gwt.client.copy.element.GroupGridElement;
...
import com.baselet.gwt.client.copy.umlet.element.experimental.settings.facets.DefaultGlobalFacet.ElementStyleEnum;
...
//		this.getHandler().getDrawPanel().getSelector().updateSelectorInformation(); // update the property panel to display changed attributes
	...
	/**
	 * @see com.baselet.gwt.client.copy.element.GridElement#getRealSize()
	 */
	@Override
