...
abstract class ArrowEnd implements RegexValueHolder {
	...
	abstract void print(DrawHandler drawer, RelationPoints points, Line lineToDraw, boolean drawOnLineStart, String matchedText);

	static ArrowEnd LEFT_NORMAL = new ArrowEnd("<") {
		@Override
		public void print(DrawHandler drawer, RelationPoints points, Line lineToDraw, boolean drawOnLineStart, String matchedText) {
	...
	static ArrowEnd BOX_TEXT = new ArrowEnd("\\[[^\\]]+]") {
		...
		public void print(DrawHandler drawer, RelationPoints points, Line lineToDraw, boolean drawOnLineStart, String matchedText) {
			...
			RelationDrawer.drawBoxArrowText(drawer, lineToDraw, drawOnLineStart, textWithoutBox);
		}
	};
}