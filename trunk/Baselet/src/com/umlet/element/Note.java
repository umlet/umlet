...
public class Note extends OldGridElement {
	...
	public void paintEntity(Graphics g) {
		...
		poly.addPoint(0, 0);
		poly.addPoint(this.getZoomedSize().width - (int) this.getHandler().getFontHandler().getFontSize(), 0);
		poly.addPoint(this.getZoomedSize().width - (int) this.getHandler().getFontHandler().getFontSize(), 0);
		poly.addPoint(this.getZoomedSize().width - 1, (int) this.getHandler().getFontHandler().getFontSize());
		poly.addPoint(this.getZoomedSize().width - 1, (int) this.getHandler().getFontHandler().getFontSize());
		...
		g2.drawLine(this.getZoomedSize().width - (int) this.getHandler().getFontHandler().getFontSize(), 0, this.getZoomedSize().width - 1, (int) this.getHandler().getFontHandler().getFontSize());
		g2.drawLine(this.getZoomedSize().width - 1, (int) this.getHandler().getFontHandler().getFontSize(), this.getZoomedSize().width - 1, this.getZoomedSize().height - 1);
		...
		g2.drawLine(this.getZoomedSize().width - (int) this.getHandler().getFontHandler().getFontSize(), 0, this.getZoomedSize().width - (int) this.getHandler().getFontHandler().getFontSize(), (int) this.getHandler().getFontHandler().getFontSize());
		g2.drawLine(this.getZoomedSize().width - (int) this.getHandler().getFontHandler().getFontSize(), (int) this.getHandler().getFontHandler().getFontSize(), this.getZoomedSize().width - 1, (int) this.getHandler().getFontHandler().getFontSize());
	}
}
