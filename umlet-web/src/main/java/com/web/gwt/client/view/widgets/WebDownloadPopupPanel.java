...
import com.baselet.gwt.client.jsinterop.BlobStream;
    ...
    public void prepare(FilenameAndScaleHolder filenameAndScaleHolder) {
        ...
        textBox.addDomHandler(new InputHandler() {
            ...
            public void onInput(InputEvent event) {
				...
				String scaledPdfUrl = CanvasUtils.createPdfCanvasDataUrl(diagram, filenameAndScaleHolder.getScaling());
				downloadLinkHtml.setHTML(createDownloadLinks(uxfUrl, scaledPngUrl, scaledPdfUrl, filenameAndScaleHolder.getFilename()));
            }
        }, InputEvent.getType());
