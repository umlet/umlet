...
public class RelationDrawer {
	...
	public static enum ArrowEndType {
		NORMAL, CLOSED, DIAMOND, MEASURE, SINGLE_HASH, DOUBLE_HASH
	}
	...
	public static void drawArrowToLine(PointDouble point, DrawHandler drawer, Line line, boolean drawOnStart, ArrowEndType arrowEndType, boolean fillBody, boolean invertArrow) {
		...
		if (arrowEndType == ArrowEndType.MEASURE || arrowEndType == ArrowEndType.SINGLE_HASH || arrowEndType == ArrowEndType.DOUBLE_HASH) {
		...
		if (arrowEndType == ArrowEndType.DOUBLE_HASH) {
		...
		if (arrowEndType != ArrowEndType.SINGLE_HASH && arrowEndType != ArrowEndType.DOUBLE_HASH) {
			points.add(p1);
			points.add(point);
			points.add(p2);
	...
	public static void drawCircle(DrawHandler drawer, Line line, boolean drawOnStart, ResizableObject resizableObject, Direction openDirection, boolean drawCross) {
		double circleRadius = openDirection == null ? RelationPointConstants.POINT_SELECTION_RADIUS : RelationPointConstants.POINT_SELECTION_RADIUS * 3;
