...
public class RelationLineTypeFacet extends FirstRunKeyValueFacet {
	...
	private static final List<ArrowEnd> SHARED_ARROW_STRINGS_AFTER = Arrays.asList(ArrowEnd.DOUBLE_HASH, ArrowEnd.SINGLE_HASH, ArrowEnd.ONE_ONE, ArrowEnd.ONE, ArrowEnd.ZERO, ArrowEnd.BOX);
