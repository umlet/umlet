...
public abstract class Theme {
    ...
    public enum ColorStyle {
        SELECTION_FG, SELECTION_BG, STICKING_POLYGON, SYNTAX_HIGHLIGHTING, DEFAULT_FOREGROUND, DEFAULT_BACKGROUND, DEFAULT_DOCUMENT_BACKGROUND, DEFAULT_SPLITTER_COLOR
    }
