...
public class Paste extends Command {
	...
	public void execute(DiagramHandler handler) {
		...
		for (Entity e : this.entities) {
			...
			// }
			(new AddEntity(e,
					handler.realignToGrid(e.getX() - minX + upperLeftX / oldZoom * Constants.DEFAULTGRIDSIZE + Constants.PASTE_DISPLACEMENT),
					handler.realignToGrid(e.getY() - minY + upperLeftY / oldZoom * Constants.DEFAULTGRIDSIZE + Constants.PASTE_DISPLACEMENT))).execute(handler);
		}
