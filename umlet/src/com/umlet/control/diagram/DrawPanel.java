...
public class DrawPanel extends JPanel implements Printable {
	...
	public void setStartUpHelpLabel(StartUpHelpText text) {
//		this.addContainerListener(text);
		this.add(text);
	}
	...
	public void showNotification(String message){
		...
		Rectangle currentView = getScrollPanel().getViewport().getViewRect();
		int x = (int) (currentView.getMaxX()-110);
